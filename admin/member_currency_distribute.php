...
if (isset($_SESSION['member_rank']) && ($_SESSION['member_rank'] == 1 || $_SESSION['member_rank'] == 2 || $_SESSION['member_rank'] == 4)) {
    ...
    if (isset($_POST['member_id']) && isset($_POST['quantity']) && isset($_POST['topic'])) {
        ...
        $inserted_currency_text = TRANSLATIONS[$language]['admin']['text_log_distribute_currency'].': '.$quantity;
        ...
        insert_message($_SESSION['member_id'], $member_id, TRANSLATIONS[$language]['admin']['text_log_distribute_currency_topic'], $text, 1);
