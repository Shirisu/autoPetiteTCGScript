...
if($_SESSION['member_rank'] == 1 || $_SESSION['member_rank'] == 2 || $_SESSION['member_rank'] == 3) {
    ...
    if (isset($carddeckId)) {
        ...
        $breadcrumb = array(
            ...
            '/administration/editcarddeck/'.$carddeckId => $carddeck_name,
        );
        ...
        ?>
        <form action="/administration/editcarddeck/<?php echo $carddeckId; ?>" method="post" enctype="multipart/form-data">
            <div class="row align-items-center">
                <div class="form-group col col-12 col-md-6 mb-2">
                    <div class="input-group">
                        ...
                        <input type="text" disabled class="form-control" aria-describedby="ariaDescribedbyID" required value="<?php echo $row['carddeck_id']; ?>" />
                    </div>
                    <input type="hidden" class="form-control" id="carddeck_id" name="carddeck_id" value="<?php echo $row['carddeck_id']; ?>" />
                </div>
                <div class="form-group col col-12 col-md-6 mb-2">
                    <div class="input-group">
                        <div class="input-group-prepend">
                        ...
                        <input type="text" disabled class="form-control" id="carddeck_name" name="carddeck_name" aria-describedby="ariaDescribedbyName" pattern="[a-z0-9-_]*" maxlength="50" value="<?php echo $carddeck_name; ?>" required />
                    </div>
                    <input type="hidden" class="form-control" id="carddeck_name" name="carddeck_name" value="<?php echo $row['carddeck_name']; ?>" />
                </div>
                <div class="form-group col col-12 col-md-6 mb-2">
                    <div class="input-group">
                        <div class="input-group-prepend">
                        ...
                        <input type="text" class="form-control" id="carddeck_series" name="carddeck_series" aria-describedby="ariaDescribedbySeries" maxlength="255" value="<?php echo $carddeck_series; ?>" required />
                    </div>
                </div>
                <div class="form-group col col-12 col-md-6 mb-2">
                    <div class="input-group">
                        ...
                        <select class="custom-select" id="carddeck_is_puzzle" name="carddeck_is_puzzle" aria-describedby="ariaDescribedbyIsPuzzle" required>
                            ...
                            <option value="0" <?php echo ($carddeck_is_puzzle == 0 ? 'selected': ''); ?>><?php echo TRANSLATIONS[$GLOBALS['language']]['general']['text_no']; ?></option>
                            <option value="1" <?php echo ($carddeck_is_puzzle == 1 ? 'selected': ''); ?>><?php echo TRANSLATIONS[$GLOBALS['language']]['general']['text_yes']; ?></option>
                        </select>
                    </div>
                </div>
                <div class="form-group col col-12 col-md-6 mb-2">
                        ...
                        <div class="input-group">
                            ...
                            <select class="custom-select" id="carddeck_creator" name="carddeck_creator" aria-describedby="ariaDescribedbyCreator" required>
                                ...
                                while ($row_member = mysqli_fetch_assoc($result_member)) {
                                    ?>
                                    <option value="<?php echo $row_member['member_id']; ?>" <?php echo ($carddeck_creator == $row_member['member_id'] ? 'selected': ''); ?>><?php echo $row_member['member_nick']; ?></option>
                                    <?php
                                }
                                ?>
                            </select>
                ...
                <div class="form-group col col-12 col-md-6 mb-2">
                    <div class="input-group">
                        ...
                        <select class="custom-select" id="carddeck_active" name="carddeck_active" aria-describedby="ariaDescribedbyStatus" required>
                            <option selected disabled hidden value=""></option>
                            <option value="0" <?php echo ($carddeck_active == 0 ? 'selected': ''); ?>><?php echo TRANSLATIONS[$GLOBALS['language']]['general']['text_inactive']; ?></option>
                            <option value="1" <?php echo ($carddeck_active == 1 ? 'selected': ''); ?>><?php echo TRANSLATIONS[$GLOBALS['language']]['general']['text_active']; ?></option>
                        </select>
                    </div>
                </div>
                            ...
                            <select class="custom-select" id="carddeck_category" name="carddeck_category" aria-describedby="ariaDescribedbyCategory" required>
                                ...
                                while ($row_category = mysqli_fetch_assoc($result_category)) {
                                    ...
                                    while ($row_sub_category = mysqli_fetch_assoc($result_sub_category)) {
                                        ?>
                                        <option value="<?php echo $row_category['carddeck_cat_id'].';'.$row_sub_category['carddeck_sub_cat_id']; ?>" <?php echo ($carddeck_category == $row_category['carddeck_cat_id'].';'.$row_sub_category['carddeck_sub_cat_id'] ? 'selected': ''); ?>><?php echo $row_sub_category['carddeck_sub_cat_name']; ?></option>
                                        <?php
                                    }
                                }
                                ?>
                    ...
                    <div class="row">
                        <div class="form-group col col-12 col-md-6 mb-2">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="carddeck_artist" name="carddeck_artist" aria-describedby="ariaDescribedbyArtist" maxlength="255" value="<?php echo $carddeck_artist; ?>" />
                            </div>
                        ...
                        <div class="form-group col col-12 col-md-6 mb-2">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="carddeck_copyright" name="carddeck_copyright" aria-describedby="ariaDescribedbyCopyright" maxlength="255" value="<?php echo $carddeck_copyright; ?>" placeholder="<?php echo TRANSLATIONS[$GLOBALS['language']]['general']['text_link_without_beginning']; ?>" />
                            </div>
                        ...
                        <div class="form-group col col-12 mb-2">
                            <div class="input-group">
                                ...
                                <textarea class="form-control" id="carddeck_imagesources" name="carddeck_imagesources" aria-describedby="ariaDescribedbyImagesources" maxlength="255"><?php echo $carddeck_imagesources; ?></textarea>
                            </div>
                ...
                <details class="col col-12 mb-2">
                    ...
                    <div class="row">
                        <div class="form-group col col-12 mb-2">
                            <div class="mb-1">
                                <img src="<?php echo TCG_CARDS_FOLDER.'/'.$carddeck_name.'/'.$carddeck_name.'master.'.TCG_CARDS_FILE_TYPE; ?>" />
                            </div>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                ...
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="masterCardFile" name="masterCardFile" aria-describedby="ariaDescribedbyMastercard">
                        ...
                        for ($i = 1; $i <= TCG_CARDDECK_MAX_CARDS; $i++) {
                            ...
                            <div class="form-group col col-12 col-md-6 mb-2">
                                <div class="mb-1">
                                    <img src="<?php echo TCG_CARDS_FOLDER.'/'.$carddeck_name.'/'.$carddeck_name.sprintf("%'.02d", $i).'.'.TCG_CARDS_FILE_TYPE; ?>" />
                                </div>
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="cardFile<?php echo $i; ?>" name="cardFile<?php echo $i; ?>" aria-describedby="ariaDescribedbyCard<?php echo $i; ?>">
