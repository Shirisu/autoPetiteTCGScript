    ...
    if (isset($memberId)) {
        ...
        if (mysqli_num_rows($result)) {
            ...
            $breadcrumb = array(
                ...
                '/administration/deletemember/'.$memberId => TRANSLATIONS[$GLOBALS['language']]['admin']['member_administration_headline'].' - '.TRANSLATIONS[$GLOBALS['language']]['admin']['member_delete_headline'],
            );
            ...
            if (isset($_POST['member_id'])) {
                ...
                $sql_trade = "SELECT trade_from_member_id, trade_from_member_card_id, trade_to_member_id, trade_to_member_card_id
                              FROM trade
                              WHERE (trade_from_member_id = '".$memberId."'
                                  OR trade_to_member_id = '".$memberId."')";
                ...
                <div class="row">
                    ...
                    <div class="col col-12 mt-2">
                        <form action="/administration/deletemember/<?php echo $memberId; ?>" method="post">
                            <div class="row">
