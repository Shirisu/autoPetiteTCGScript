                            ...
                            <table class="optional cards-sorting-table new-cards" data-mobile-responsive="true">
                                ...
                                while ($row_cards = mysqli_fetch_assoc($result_cards)) {
                                    if ($row_cards['carddeck_active'] == 0) {
                                        ...
                                        $filterclass = get_card_filter_class($carddeck_id, $cardnumber_plain, 0, 0, MEMBER_CARDS_NEW);
                                        ...
                                        $card_already_in_keep = $can_use_strcontains ? str_contains($filterclass, 'already-in-keep') : strpos($filterclass, 'already-in-keep');
                                        ...
                                        if (
                                            ...
                                            !TCG_MULTI_MASTER) ||
                                            ($card_already_there && !$card_already_in_keep)
                                        ) {
                                            $hide_collect = true;
                                        }
                                                    ...
                                                    <div class="form-group mt-2">
                                                        <div class="input-group">
                                                            <select class="form-select" id="card_category[]"
                                                                ...
                                                                <option value="1" <?php echo($new_selected ? 'selected' : ''); ?> selected>New</option>
                                                                <option
