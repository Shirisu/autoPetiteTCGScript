        ...
        <div class="col col-12 mb-3 cards-sorting-container">
            ...
            ?>
                <form action="<?php echo HOST_URL; ?>/cards/trade" method="post">
                    <div class="row">
                        <!--Botric 20210817 changed location the button to sort from bottom to the bottom to the top  -->
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="cards-sorting-wrapper<?php echo ($carddeck_already_mastered == 1 ? ' mastered' : ''); ?>">
                                                        ...
                                                        <a class="carddeck-link" href="<?php echo HOST_URL; ?>/carddeck/<?php echo $carddeck_name; ?>">
                                                        ...
                                                        <div class="form-group mt-2">
                                                            <div class="input-group">
                                                                <select class="custom-select" id="card_category[]" name="card_category[]" aria-describedby="ariaDescribedbyLanguage" required>
                                                                    <option value="3" <?php echo ($trade_selected ? 'selected' : ''); ?>>
                                                                        Trade
                                                                    </option>
                                                                    <?php if ($hide_collect == false) { ?>
                                                                        <option value="2" <?php echo ($collect_selected ? 'selected' : ''); ?>>
                                                                            Collect</option><?php } ?>
                                                                </select>
                                                            </div>
                                                        </div>
