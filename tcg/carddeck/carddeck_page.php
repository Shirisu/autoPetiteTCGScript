            ...
            <div class="row">
                <div class="col col-12 col-xl-5 order-2 order-xl-1">
                    ...
                    <div class="row mt-3 card-same-height">
                        ...
                        <!-- by botric 17/08/2021 moved the wishlist and mastered to below the columns created to make formatting ot weird when mated to many times -->
                                ...
                                ?>
                                    <div class="col col-auto">
                                        <div class="row">
                                            ...
                                            ?>
                                                <div class="col col-auto">
                                                    <span class="mastered"><i class="fas fa-medal"></i></span> <?php echo TRANSLATIONS[$GLOBALS['language']]['general']['text_mastered_on']; ?>
