                ...
                <div class="col col-12 text-center">
                    ...
                    if (isset($category_id) && !isset($sub_category_id)) {
                        ...
                        if (mysqli_num_rows($result_carddeck_sub_cat)) {
                            ...
                            ?>
                                <a href="<?php echo HOST_URL; ?>/carddecks/<?php echo $category_id; ?>/<?php echo $row_carddeck_sub_cat['carddeck_sub_cat_id']; ?>" class="btn btn-outline-info btn-sm mb-1"><?php echo $row_carddeck_sub_cat['carddeck_sub_cat_name']; ?></a>
                            <?php
                            }
                        }
                    }
                    ...
                    if (!isset($category_id)) {
                        ...
                        if (mysqli_num_rows($result_carddeck_cat)) {
                            ...
                            ?>
                                <a href="<?php echo HOST_URL; ?>/carddecks/<?php echo $row_carddeck_cat['carddeck_cat_id']; ?>" class="btn btn-outline-info btn-sm mb-1"><?php echo $row_carddeck_cat['carddeck_cat_name']; ?></a>
                            <?php
                            }
                        }
                    }
