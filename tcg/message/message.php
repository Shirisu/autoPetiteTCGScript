...
if (isset($_SESSION['member_rank'])) {
    ...
    if (isset($action) && $action == 'delete_all_systemmessages') {
        $breadcrumb = array(
            ...
            '/message/delete/allsystemmessages' => TRANSLATIONS[$GLOBALS['language']]['message']['text_delete_all_system_messages'],
        );
        breadcrumb($breadcrumb);
        title(TRANSLATIONS[$GLOBALS['language']]['message']['text_delete_all_system_messages']);
                                ...
                                <?php if ($row_message['message_receiver_member_id'] == $member_id) { ?>
                                    <div class="card-footer">
                                        <div class="row">
                                            ...
                                            <?php } ?>
                                            <div
                                                class="col <?php echo($row_message['message_system'] == 1 ? 'col-12' : 'col-6'); ?> text-right">
                    ...
                    <div class="row">
                        <div class="col col-6 mb-2 mb-md-0">
                            <a href="<?php echo HOST_URL; ?>/message/inbox"
                               class="btn btn-outline-info btn-sm btn-block <?php echo($message_box_type == 'inbox' ? 'active' : ''); ?>"><i
                                    class="fas fa-inbox"></i> <?php echo TRANSLATIONS[$GLOBALS['language']]['message']['text_inbox']; ?>
                            </a>
                        </div>
                        <div class="col col-6 mb-2 mb-md-0">
                            <a href="<?php echo HOST_URL; ?>/message/outbox"
                               class="btn btn-outline-info btn-sm btn-block <?php echo($message_box_type == 'outbox' ? 'active' : ''); ?>"><i
