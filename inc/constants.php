...
define('TCG_NAME', 'DaGeeks-Geeks TCG'); // for title-attribute & meta title
define('TCG_SLOGAN', 'a Custom Trading Card Game'); // for title-attribute & meta title
define('TCG_META_TITLE', TCG_NAME .' :: '.TCG_SLOGAN); // title-tag & meta title

define('TCG_TEMPLATE', 2); // which template you want to use (1 is the main template)
...
define('TCG_CARDS_HEIGHT', 300); // height of card
...
define('TCG_MASTERCARDS_HEIGHT', 400); // height of master
define('TCG_MASTERCARDS_WIDTH', 300); // width of master
define('TCG_META_AUTHOR', 'DGGS'); // meta author
...
define('TCG_META_OWNER', 'dageek@dageeks-geeks.gg'); // meta owner
